...
// import { Table, Button, Space, Tag, Modal, Form, Input, InputNumber, Select, DatePicker, Row, Col, Card, Statistic, Popconfirm, message,
// } from 'antd';
// import {EyeOutlined, EditOutlined, DeleteOutlined, PlusOutlined, UserOutlined,
      ...
      <Modal title={editingElder ? 'Chỉnh sửa thông tin' : 'Thêm người cao tuổi'} open={isModalVisible} onOk={handleModalOk} onCancel={() => setIsModalVisible(false)} width={700}>
        <Form form={form} layout="vertical">
          <Row gutter={16}>
            ...
            <Col span={6}><Form.Item name="age" label="Tuổi" rules={[{ required: true }]}><InputNumber min={60} max={120} className="w-full" /></Form.Item></Col>
          </Row>
          <Row gutter={16}>
